...
function Nextslide(SlideNo){
    ...
    if(SlideNo==1){
        document.querySelector(".GoBack").styles.animation="GoBackBtnVisible 0.25s ease"
        document.querySelector(".Goback").oanimationed=function(){
...
document.querySelector("Scorller").style.marginLeft=parseInt(window.getComputedStyle(document.querySelector("scroller")).getPropertyValue("margin-left"))-478+"px";
